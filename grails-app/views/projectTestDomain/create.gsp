...
<html>
  <head>
    ...
    <title>Create Domain Test File</title>
  </head>
  <body>
    <div class="row">
      <h3 class="page-header">
        Create Domain Test File
      </h3>
    </div>
    <div class="row">
      <ol class="breadcrumb">
        ...
        <li class="active">Create Domain Test File</li>
      </ol>
    </div>
    <div class="row">
      ...
      <g:form action="save">
        ...
        <g:hiddenField name="isTest" value="${projectTestDomain?.isTest}" />
        <div class="row">
