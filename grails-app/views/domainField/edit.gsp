...
<html>
  ...
  <body>
    ...
    <div class="row">
      ...
      <g:form resource="${this.domainField}" method="PUT">
        <g:hiddenField name="version" value="${this.domainField?.version}" />
        <div class="row">
          ...
          <div class="col-lg-12">
            <g:link class="btn btn-warning" action="show" id="${domainField.id}">
              Cancel
            </g:link>
      ...
      <g:form name="formDelete" class="pull-left" resource="${this.domainField}" method="DELETE"></g:form>
    </div>
